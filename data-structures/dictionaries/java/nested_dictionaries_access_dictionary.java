...
class NestedDictionaries  {
    ...
    public static void main(String[] args) {
        ...
        HashMap<String, String> astronaut = astronautsByName.get("Fei Junlong");

        // Output the astronaut's spacecraft and days
        String spacecraft = astronaut.get("craft");
        String days = astronaut.get("days");
        System.out.println("Fei Junlong has spent " + days + " days on the " + spacecraft);
    }
