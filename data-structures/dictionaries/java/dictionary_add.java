...
class SingleDictionaries  {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Enter the astronaut's country:");
        String inputCountry = scanner.nextLine();

        // Add the country key-value pair to the dictionary
        astronaut.put("country", inputCountry);

        // Output the country of origin
        String newCountry = astronaut.get("country");
        System.out.println("The country " + newCountry + " has been added");
    }
}