...
class NestedLists  {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("The days has been updated to " + allAstronauts.get(position).get(DAYS_INDEX));
    }

    // Update the number of days in space for an astronaut
    public static void updateDaysInSpace(ArrayList<ArrayList<String>> allAstronauts,
                                         int astronautIndex, String newDays) {

        allAstronauts.get(astronautIndex).set(DAYS_INDEX, newDays);
    }
