...
class Arrays3D  {
    ...
    public static void main(String[] args) {
        ...
        int wordIndex = 4;
        String oldWord = spellingWords[YEAR_1][LEVEL_3][wordIndex];

        // Update the word for Year 1, Level 3 at index 4
        spellingWords[YEAR_1][LEVEL_3][wordIndex] = newWord;

        // Output the updated word
        String updatedWord = spellingWords[YEAR_1][LEVEL_3][wordIndex];
