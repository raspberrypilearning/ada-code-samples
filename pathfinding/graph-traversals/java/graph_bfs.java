...
class GraphTraversals
{
    ...
    public static void main(String[] args) {
        ...
        System.out.println("### Graph traversal - breadth-first search (BFS) ###");

        // Search for a value and return true if it has been found
        String itemToFind = "4";
        String start = "1";
        System.out.println("\nStarting at " + start + ": The target node is " + itemToFind);
        boolean found = breadthFirstSearch(testGraph, start, itemToFind);
    ...
    // A breadth-first search performed on a graph stored as a hashmap
    public static boolean breadthFirstSearch(HashMap<String, List<String>> graph,
